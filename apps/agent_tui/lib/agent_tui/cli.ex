defmodule AgentTui.CLI do
  @moduledoc """
  Command-line entrypoint for the terminal UI app.
  """
  ...
  defp session_opts(args) do
    ...
    if flags[:model] do
      opts = [
        model_client: AgentCore.ModelClient.OpenAIResponses,
        model_opts:
          [
            model: flags[:model],
